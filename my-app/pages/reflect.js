...
export default function MyResumes() {
  return (
    <>
      <Head>
        <title>Reflect - gossip.ai</title>
        <meta name="description" content="Reflect on your work stories" />
      ...
      <div className={`${styles.container} ${geistSans.variable} ${geistMono.variable}`}>
        ...
        <section style={{ marginTop: "6rem", padding: "4rem 2rem", minHeight: "60vh" }}>
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <h1 style={{ fontSize: "32px", marginBottom: "20px" }}>Reflect</h1>
            <p style={{ color: "#bbb", lineHeight: "1.6" }}>
              Coming soon... Review and reflect on your work stories and experiences.
            </p>
          </div>
        </section>
